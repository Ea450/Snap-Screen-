    ...
    return (
        <main className="sign-in">
            <aside className="testimonial">
                    ...
                    <section>
                        <figure>
                            {Array.from({ length: 5 }).map((_, i) => (
                                <Image src='/assets/icons/star.svg' alt="star" width={28} height={28}
                                    key={i} />
                            ))}
                        </figure>
                ...
                <p>SnapScreen {(new Date()).getFullYear()}</p>
            </aside>
            <aside className="google-sign-in">
                <section>
                    ...
                    <p>Create and share your first <span>SnapScreen video</span>in no time!</p>
